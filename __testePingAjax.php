...
if($socket =@ fsockopen($host, 28080, $errno, $errstr, 1)) {
...
// <a href="http://192.168.15.254/phpvirtualbox/" class="btn btn-info" role="button">Loja 13</a>
                                ...
                                if($socket =@ fsockopen($host, 28080, $errno, $errstr, 5)) {
                                echo ' <span class="label label-success">FW 13 ONLINE</span>';
                                fclose($socket);
                                } else {
                                ...
                                if($socket =@ fsockopen($host, 28080, $errno, $errstr, 5)) {
                                echo '<a href="http://192.168.76.254/phpvirtualbox/" <span class="label label-success">FW 76 ONLINE</span> </a>';
                                fclose($socket);
                                } else {
                        	...
                        	<div class="col-md-3"> <h1>Eletros 2</h1>
                               ...
                               <div class="list-group-item">
                                  ...
                                  <p class="list-group-item-text">
                                <?php
                                $host = '192.168.4.235:445';
                                if($socket =@ fsockopen($host, 445, $errno, $errstr, 5)) {
                                echo ' <span class="label label-success">PC WILSON ONLINE</span>';
                                fclose($socket);
                                } else {
                                echo ' <span class="label label-danger">PC WILSON OFFLINE</span> ';
                                }
